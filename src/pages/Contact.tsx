...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Phone",
      details: ["+91 97000 45000", "+91 040 27135000"],
      action: "tel:+919700045000"
    },
    {
      icon: <Mail className="h-8 w-8 text-yellow-500" />,
      title: "Email",
      details: ["info@moulya.in"],
      action: "mailto:info@moulya.in"
    },
    {
      icon: <MapPin className="h-8 w-8 text-yellow-500" />,
      title: "Address",
      details: ["7-59/32, Tirumala enclave", "Dammaiguda, ECIL", "Hyderabad - 500083"],
      action: "#"
    },
    {
  ...
  const cities = [
    ...
    'Rangareddy', 'Medchal', 'Malkajgiri', 'Sangareddy', 'Mahbubnagar', 'Adilabad', 'Nirmal',
    'Siddipet', 'Jagitial', 'Peddapalli', 'Bhadradri Kothagudem', 'Kamareddy', 'ECIL', 'Dammaiguda'
  ];
      ...
      <section className="py-20 bg-yellow-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="tel:+914027135000"
              className="bg-gray-900 hover:bg-gray-800 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors"
            >
              Landline: +91 040 27135000
            </a>
            <a
